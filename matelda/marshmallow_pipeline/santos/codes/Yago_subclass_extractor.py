...
"""
classes = open(
    "marshmallow_pipeline/santos/yago/yago-original/yago-wd-class.nt",
    "r",
    encoding="utf-8",
)
schema = open(
    "marshmallow_pipeline/santos/yago/yago-original/yago-wd-schema.nt",
    "r",
    encoding="utf-8",
)
...
relationship = open(
    "marshmallow_pipeline/santos/yago/yago-subclass", "w+", encoding="utf-8"
)
for i in dict.items():
