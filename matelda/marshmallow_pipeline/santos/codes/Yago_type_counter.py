...
full_types = open(
    "marshmallow_pipeline/santos/yago/yago-original/yago-wd-full-types.nt",
    "r",
    encoding="utf-8",
)
...
simple_types = open(
    "marshmallow_pipeline/santos/yago/yago-original/yago-wd-simple-types.nt",
    "r",
    encoding="utf-8",
)
...
facts = open(
    "marshmallow_pipeline/santos/yago/yago-original/yago-wd-facts.nt",
    "r",
    encoding="utf-8",
)
