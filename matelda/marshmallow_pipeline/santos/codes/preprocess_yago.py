...
def findAllEdges(path):
    ...
    with open(path, "r", encoding="UTF-8") as infile:
        for line in infile:
            ...
            j += 1
            if (
                "rdf-schema#subclassof" in line
                and "http://schema.org/thing" not in line
            ):
                parent, child = getParentAndChild(line)
...
# ENTITY DICTIONARY
LABEL_INPUT_FILE_PATH = (
    r"marshmallow_pipeline/santos/yago/yago-original/yago-wd-labels.nt"
)
LABEL_OUTPUT_FILE_PATH = (
    r"marshmallow_pipeline/santos/yago/yago_pickle/yago-wd-labels_dict.pickle"
)

# TYPE DICTIONARY
FULL_TYPES_INPUT_FILE_PATH = (
    r"marshmallow_pipeline/santos/yago/yago-original/yago-wd-full-types.nt"
)
SIMPLE_TYPES_INPUT_FILE_PATH = (
    r"marshmallow_pipeline/santos/yago/yago-original/yago-wd-simple-types.nt"
)
TYPES_OUTPUT_FILE_PATH = (
    r"marshmallow_pipeline/santos/yago/yago_pickle/yago-wd-full-types_dict.pickle"
)

# INHERITANCE DICTIONARY
CLASS_INPUT_FILE_PATH = (
    r"marshmallow_pipeline/santos/yago/yago-original/yago-wd-class.nt"
)
CLASS_OUTPUT_FILE_PATH = (
    r"marshmallow_pipeline/santos/yago/yago_pickle/yago-wd-class_dict.pickle"
)

# RELATIONSHIP DICTIONARY
FACTS_INPUT_FILE_PATH = (
    r"marshmallow_pipeline/santos/yago/yago-original/yago-wd-facts.nt"
)
FACTS_OUTPUT_FILE_PATH = (
    r"marshmallow_pipeline/santos/yago/yago_pickle/yago-wd-facts_dict.pickle"
)
